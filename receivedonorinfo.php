                ...
                <ul class="nav-area">
                    ...
                    <form action="" method="GET">
                        <select name="sort_alphabet" class="form-control">
                            ...
                            <option value="a-z" <?php if(isset ($_GET['sort_alphabet']) && $_GET['sort_alphabet'] =="a-z") {echo "selected";} ?> >A-Z (Asc)</option>
                            <option value="z-a" <?php if(isset ($_GET['sort_alphabet']) && $_GET['sort_alphabet'] =="z-a") {echo "selected";} ?>>Z-A(Dsc)</option>
                            <option value="blood" <?php if(isset ($_GET['sort_alphabet']) && $_GET['sort_alphabet'] =="blood") {echo "selected";} ?>>Blood Group</option>
                            <option value="loc" <?php if(isset ($_GET['sort_alphabet']) && $_GET['sort_alphabet'] =="loc") {echo "selected";} ?>>Location</option>
                        </select>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        if(isset($_GET['sort_alphabet']))
                                        {
                                            ...
                                            {
                                                $sort_option= "ASC";
                                                $query="SELECT * FROM donor ORDER BY name $sort_option limit 8" ;
                                            ...
                                            elseif($_GET['sort_alphabet']=="blood")
                                            {
                                                $sort_option = "ASC";
                                                $query="SELECT * FROM donor ORDER BY bloodgroup $sort_option limit 8" ;
                                                $query_run=mysqli_query($con,$query);    
                                            }
                                            elseif($_GET['sort_alphabet']=="loc")
                                            {
                                                $sort_option = "ASC";
                                                $query="SELECT * FROM donor ORDER BY location $sort_option limit 8" ;
                                                $query_run=mysqli_query($con,$query);    
                                            }
                                            else
                                            {
                                                $query="SELECT * FROM donor limit 8" ;
                                                $query_run=mysqli_query($con,$query);  
                                            }
                                        }
